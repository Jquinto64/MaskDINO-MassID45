...
# # FOR SAHI DATASETS - SR
# SR_METHOD=swinir_bioscan
# python train_net.py --num-gpus 4 \
# --resume \
# --exp_id $SR_METHOD \
# --config-file /h/jquinto/MaskDINO/configs/lifeplan/instance-segmentation/maskdino_R50_bs16_50ep_3s_dowsample1_2048.yaml \
# --dataset_path /h/jquinto/MaskDINO/datasets/lifeplan_2x_zoom_SR_${SR_METHOD}/ \
# OUTPUT_DIR output_lifeplan_2x_zoom_SR_${SR_METHOD}_v9_R50_1024_one_cycle_lr_5e-5_colour_augs_15k_iters \
# DATASETS.TRAIN "(\"lifeplan_${SR_METHOD}_train\",)" \
# DATASETS.TEST "(\"lifeplan_${SR_METHOD}_valid\",)"  \
# MODEL.WEIGHTS /h/jquinto/MaskDINO/maskdino_r50_50ep_300q_hid2048_3sd1_instance_maskenhanced_mask46.3ap_box51.7ap.pth \
